...
The documentation is under construction and it's available at [https://angular-package.gitbook.io/property](https://angular-package.gitbook.io/property)
...
Learn how to use property package [here](https://angular-package.gitbook.io/property/learn/how-to-use).
...
```typescript
class Descriptor<Value, Obj extends object = object> { ... }
```
...
```typescript
class AccessorDescriptors<Value, Obj extends object> { ... }
```
...
The static method sets the property `value` of `name` in `object`.
...
To read it, click on the [CHANGELOG.md][property-github-changelog] link.
...
<!-- This package -->
  [property-github-changelog]: https://github.com/angular-package/property/blob/main/CHANGELOG.md
